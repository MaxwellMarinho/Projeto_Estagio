    ...
    <ul class="sidebar navbar-nav shadow">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="chamadosDropdown">
          <a class="dropdown-item active">Novos</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="{{ route('user_tech.show','aceitos')}}">Andamento</a>
          <div class="dropdown-divider"></div>
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          ...
          <div class="bg-light shadow-sm p-4 m-2">
            ...
            <h2 class="h4 text-secondary">Chamados Novos</h2>
            <hr>
          ...
          <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="POST" action="{{ route('user_tech.update','test')}}">
                {!! method_field('PATCH') !!}  
                {{ csrf_field() }}
