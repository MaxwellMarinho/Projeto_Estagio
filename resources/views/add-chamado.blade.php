    ...
    <ul class="sidebar navbar-nav shadow">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="chamadosDropdown">
          ...
          <a class="dropdown-item" href="{{ route('user_user.index')}}">Histórico</a>
        </div>
      </li>
    </ul>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{ route('user_user.index')}}">Histórico de chamados</a>
          </li>
        </ol>
        ...
        <div class="container">
          ...
          <div class="bg-light shadow-sm p-4 m-2">
            ...
            <form method="POST" action="{{ route('user_user.store')}}">
                @csrf
